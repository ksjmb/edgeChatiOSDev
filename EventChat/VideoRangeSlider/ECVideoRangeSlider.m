...
#import "ECSliderLeft.h"
#import "ECSliderRight.h"
#import "ECResiziableBubble.h"
@interface ECVideoRangeSlider ()

@property (nonatomic, strong) AVAssetImageGenerator *imageGenerator;
@property (nonatomic, strong) UIView *bgView;
@property (nonatomic, strong) UIView *centerView;
@property (nonatomic, strong) NSURL *videoUrl;
@property (nonatomic, strong) ECSliderLeft *leftThumb;
@property (nonatomic, strong) ECSliderRight *rightThumb;
@property (nonatomic) CGFloat frame_width;
@property (nonatomic) Float64 durationSeconds;
@property (nonatomic, strong) ECResiziableBubble *popoverBubble;

@end

@implementation ECVideoRangeSlider
...
- (id)initWithFrame:(CGRect)frame videoUrl:(NSURL *)videoUrl{
    ...
    if (self) {
        ...
        _leftThumb = [[ECSliderLeft alloc] initWithFrame:CGRectMake(0, 0, thumbWidth, frame.size.height)];
        ...
        _rightThumb = [[ECSliderRight alloc] initWithFrame:CGRectMake(0, 0, thumbWidth, frame.size.height)];
    ...
    [self.imageGenerator generateCGImagesAsynchronouslyForTimes:times
                                              completionHandler:^(CMTime requestedTime, CGImageRef image, CMTime actualTime,
                                                  ...
                                                  if (result == AVAssetImageGeneratorSucceeded) {
                                                      ...
                                                      // videoScreen = [self normalizedImage:videoScreen];
