...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    NSError *infoError = nil;
    ECUser *ecUser = [[ECUser alloc] initWithDictionary:[self.usersArray objectAtIndex:indexPath.row] error:&infoError];
    ECIndividualProfileViewController *indVC = [self.storyboard instantiateViewControllerWithIdentifier:@"ECIndividualProfileViewController"];
    indVC.isSignedInUser = false;
    indVC.selectedEcUser = ecUser;
