...
-(void) setupConstraints
{
    ...
    self.airplayButton.keepLeftOffsetTo(self.playBackTotalTime).max = 20;
...
//    [self.progressBar setThumbImage:[UIImage imageNamed:@"Slider_button"] forState:UIControlStateNormal];
    ...
    self.topToolBar = [[UIToolbar alloc] initWithFrame:CGRectMake(0, 20, self.bounds.size.width, 44.0)];
...
-(void) showHud:(BOOL)show
{
    ...
    if(show) {
        ...
        [UIView animateWithDuration:0.3 animations:^{
            ...
            weakself.topToolBar.layer.opacity = 0;
            viewIsShowing = show;
        }];
    } else {
        CGRect frame = self.playerHudBottom.frame;
        ...
        [UIView animateWithDuration:0.3 animations:^{
            ...
            weakself.topToolBar.layer.opacity = 1;
            viewIsShowing = show;
        }];
    }
}
